...
public class PriestUpdateRequestDTO extends PersonCadastralUpdateRequestDTO {
    ...
    public PriestUpdateRequestDTO() {
    }

    public PriestUpdateRequestDTO(String name, String phoneNumber, LocalDate birthdayDate) {
        this.name = name;
