...
public class EucharisticMinisterUpdateRequestDTO extends PersonCadastralUpdateRequestDTO {
    ...
    public EucharisticMinisterUpdateRequestDTO() {
    }

    public EucharisticMinisterUpdateRequestDTO(String name, String phoneNumber, LocalDate birthdayDate) {
        this.name = name;
