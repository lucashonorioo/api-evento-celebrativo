...
public class PriestRequestDTO implements PersonAccessRequest {
    ...
    public PriestRequestDTO(String name, String phoneNumber, LocalDate birthdayDate, String password) {
        this.name = name;
