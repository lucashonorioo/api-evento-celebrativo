...
public class MinisterOfTheWordUpdateRequestDTO extends PersonCadastralUpdateRequestDTO {
    ...
    public MinisterOfTheWordUpdateRequestDTO() {
    }

    public MinisterOfTheWordUpdateRequestDTO(String name, String phoneNumber, LocalDate birthdayDate) {
        this.name = name;
