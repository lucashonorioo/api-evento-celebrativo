...
public class CommentatorUpdateRequestDTO extends PersonCadastralUpdateRequestDTO {
    ...
    public CommentatorUpdateRequestDTO() {
    }

    public CommentatorUpdateRequestDTO(String name, String phoneNumber, LocalDate birthdayDate) {
        this.name = name;
