...
public class ReaderRequestDTO implements PersonAccessRequest {
    ...
    public ReaderRequestDTO(String name, String phoneNumber, LocalDate birthdayDate, String password) {
        this.name = name;
