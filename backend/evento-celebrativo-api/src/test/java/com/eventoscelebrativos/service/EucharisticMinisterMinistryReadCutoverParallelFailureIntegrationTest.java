...
class EucharisticMinisterMinistryReadCutoverParallelFailureIntegrationTest {
    ...
    void shouldPropagateOfficialParallelFailureWithoutUsingLegacyFallback() {
        ...
        assertThrows(Exception.class, () ->
                mockMvc.perform(get("/ministrosDeEucaristia").with(user("operator").roles("OPERATOR"))).andReturn()
        );
    }
}
