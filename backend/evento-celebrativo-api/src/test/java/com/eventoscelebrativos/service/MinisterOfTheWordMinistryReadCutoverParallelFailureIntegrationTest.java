...
class MinisterOfTheWordMinistryReadCutoverParallelFailureIntegrationTest {
    ...
    void shouldPropagateOfficialParallelFailureWithoutUsingLegacyFallback() {
        ...
        assertThrows(Exception.class, () ->
                mockMvc.perform(get("/ministrosDaPalavra").with(user("operator").roles("OPERATOR"))).andReturn()
        );
    }
}
