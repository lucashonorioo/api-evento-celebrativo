...
INSERT INTO tb_person_ministry(person_id, ministry_type, ministry_id, active, created_at, updated_at) VALUES (1, 'COMMENTATOR', (SELECT id FROM tb_ministry WHERE normalized_name = 'COMENTARISTAS'), TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
INSERT INTO tb_person_ministry(person_id, ministry_type, ministry_id, active, created_at, updated_at) VALUES (2, 'COMMENTATOR', (SELECT id FROM tb_ministry WHERE normalized_name = 'COMENTARISTAS'), TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
INSERT INTO tb_person_ministry(person_id, ministry_type, ministry_id, active, created_at, updated_at) VALUES (3, 'COMMENTATOR', (SELECT id FROM tb_ministry WHERE normalized_name = 'COMENTARISTAS'), TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
INSERT INTO tb_person_ministry(person_id, ministry_type, ministry_id, active, created_at, updated_at) VALUES (4, 'READER', (SELECT id FROM tb_ministry WHERE normalized_name = 'LEITORES'), TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
INSERT INTO tb_person_ministry(person_id, ministry_type, ministry_id, active, created_at, updated_at) VALUES (5, 'READER', (SELECT id FROM tb_ministry WHERE normalized_name = 'LEITORES'), TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
INSERT INTO tb_person_ministry(person_id, ministry_type, ministry_id, active, created_at, updated_at) VALUES (6, 'READER', (SELECT id FROM tb_ministry WHERE normalized_name = 'LEITORES'), TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
INSERT INTO tb_person_ministry(person_id, ministry_type, ministry_id, active, created_at, updated_at) VALUES (7, 'MINISTER_OF_THE_WORD', (SELECT id FROM tb_ministry WHERE normalized_name = 'MINISTROS DA PALAVRA'), TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
INSERT INTO tb_person_ministry(person_id, ministry_type, ministry_id, active, created_at, updated_at) VALUES (8, 'MINISTER_OF_THE_WORD', (SELECT id FROM tb_ministry WHERE normalized_name = 'MINISTROS DA PALAVRA'), TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
INSERT INTO tb_person_ministry(person_id, ministry_type, ministry_id, active, created_at, updated_at) VALUES (9, 'MINISTER_OF_THE_WORD', (SELECT id FROM tb_ministry WHERE normalized_name = 'MINISTROS DA PALAVRA'), TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
INSERT INTO tb_person_ministry(person_id, ministry_type, ministry_id, active, created_at, updated_at) VALUES (10, 'EUCHARISTIC_MINISTER', (SELECT id FROM tb_ministry WHERE normalized_name = 'MINISTROS DA EUCARISTIA'), TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
INSERT INTO tb_person_ministry(person_id, ministry_type, ministry_id, active, created_at, updated_at) VALUES (11, 'EUCHARISTIC_MINISTER', (SELECT id FROM tb_ministry WHERE normalized_name = 'MINISTROS DA EUCARISTIA'), TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
INSERT INTO tb_person_ministry(person_id, ministry_type, ministry_id, active, created_at, updated_at) VALUES (12, 'EUCHARISTIC_MINISTER', (SELECT id FROM tb_ministry WHERE normalized_name = 'MINISTROS DA EUCARISTIA'), TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
INSERT INTO tb_person_ministry(person_id, ministry_type, ministry_id, active, created_at, updated_at) VALUES (13, 'PRIEST', (SELECT id FROM tb_ministry WHERE normalized_name = 'PRESBITEROS'), TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
INSERT INTO tb_person_ministry(person_id, ministry_type, ministry_id, active, created_at, updated_at) VALUES (14, 'PRIEST', (SELECT id FROM tb_ministry WHERE normalized_name = 'PRESBITEROS'), TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
INSERT INTO tb_person_ministry(person_id, ministry_type, ministry_id, active, created_at, updated_at) VALUES (15, 'PRIEST', (SELECT id FROM tb_ministry WHERE normalized_name = 'PRESBITEROS'), TRUE, CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6));
