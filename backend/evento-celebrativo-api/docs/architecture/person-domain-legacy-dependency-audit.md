...
Apesar disso, o modelo legado ainda e uma dependencia ativa. A remocao imediata de `tb_event_person` (ja removida fisicamente, ver acima), `person_type` ou subclasses de `Person` nao e segura.
