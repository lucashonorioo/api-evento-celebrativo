...
- a administracao de usuarios continua expondo e filtrando `personType` no contrato HTTP consumido pelo frontend, mas a fonte interna passou de `person_type` para `PersonMinistry` (ver atualizacao acima);
