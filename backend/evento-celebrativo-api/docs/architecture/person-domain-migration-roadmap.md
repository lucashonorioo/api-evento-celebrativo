...
- Endpoints, DTOs, mappers de resposta, consulta mensal, escala eucaristica e detalhe de evento continuam com contratos HTTP inalterados; os demais endpoints de eventos e escalas continuam usando o modelo legado.
- A proxima etapa de escalas dependera da estabilidade deste primeiro cutover antes de preparar novas leituras oficiais por `tb_event_assignment`.
