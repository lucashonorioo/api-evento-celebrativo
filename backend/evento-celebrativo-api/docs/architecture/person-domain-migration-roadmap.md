...
- `tb_event_person` permanece preservada e nenhuma estrutura legada foi removida; a proxima etapa sera observar os resultados da auditoria operacional e manter um periodo de estabilidade antes de avaliar mudanca do default global.
