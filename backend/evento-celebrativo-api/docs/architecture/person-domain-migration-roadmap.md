...
4. Planejar o primeiro cutover controlado das leituras de escala para atribuicoes explicitas.
...
- A proxima etapa de escalas sera observar a estabilidade do shadow read local e preparar o primeiro cutover controlado de leitura de escala.
