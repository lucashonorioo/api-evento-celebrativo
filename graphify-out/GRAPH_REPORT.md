...
## Corpus Check
- 382 files · ~173,683 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4114 nodes · 11593 edges · 167 communities (148 shown, 19 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1525 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c5179013`
...
- MonthlyScheduleReadCutoverParallelFailureIntegrationTest
- .jwkSource
...
- .setName
- EucharisticMinisterWriteThroughRollbackIntegrationTest.java
- PersonRoleUpdateResponseDTO

## God Nodes (most connected - your core abstractions)
1. `Person` - 228 edges
2. `MinistryType` - 146 edges
3. `PersonRepository` - 84 edges
4. `CelebrationEventServiceImplTest` - 81 edges
5. `PersonMinistryRepository` - 80 edges
6. `CelebrationEvent` - 62 edges
7. `EventAssignmentType` - 61 edges
...
Cohesion: 0.07
Nodes (19): CommentatorController, DeleteMapping, GetMapping, Operation, PostMapping, PreAuthorize, PutMapping, RequestMapping (+11 more)

### Community 1 - "Event Schedule Detail Component"
Cohesion: 0.09
Nodes (3): CelebrationEventRequestDTO, CelebrationEventResponseDTO, CelebrationEventService
...
Cohesion: 0.14
Nodes (11): Page, Pageable, Query, Repository, PersonRepository, Component, PersonMinistryEligibilityResolver, SpringBootTest (+3 more)

### Community 7 - "Event Response DTOs & Exceptions"
Cohesion: 0.15
Nodes (14): ArgumentCaptor, DatabaseException, Repository, RoleRepository, EucharisticMinisterServiceImpl, PasswordEncoder, Service, PasswordEncoder (+6 more)
...
Cohesion: 0.08
Nodes (15): MinisterOfTheWordRequestDTO, MinisterOfTheWordResponseDTO, Mapper, Mapping, MinisterOfTheWordMapper, Override, PasswordEncoder, Service (+7 more)

### Community 10 - "PersonMinistry Entity & Repository Test"
Cohesion: 0.13
Nodes (13): CommentatorResponseDTO, CommentatorMapper, Mapper, Mapping, CommentatorServiceImpl, Override, PasswordEncoder, Service (+5 more)
...
Cohesion: 0.11
Nodes (15): Page, Pageable, Query, Repository, PersonMinistryRepository, PersonMinistryStatusView, PersonMinistryTypeView, Override (+7 more)
...
Cohesion: 0.15
Nodes (9): CelebrationEventScaleMapper, Mapper, Mapping, Builder, Entry, EventScaleAssignmentPlan, PersonAssignmentTypeKey, EventScaleAssignmentPlanTest (+1 more)
...
Cohesion: 0.11
Nodes (14): PersonPayload, AutoConfigureMockMvc, JdbcTemplate, JsonNode, MockMvc, MvcResult, ObjectMapper, ResultActions (+6 more)
...
Cohesion: 0.31
Nodes (5): EventAssignmentTarget, PersonAssignmentTypeKey, EventAssignmentCompatibilityServiceImplTest, Test, SuppressWarnings
...
Cohesion: 0.20
Nodes (9): AutoConfigureMockMvc, JdbcTemplate, MockMvc, ObjectMapper, SpringBootTest, Test, WithMockUser, MinistriesPayload (+1 more)

### Community 42 - "Event Schedule Edit Component"
Cohesion: 0.04
Nodes (50): errorMessageFor(), EventScheduleDetailComponent, isEventScheduleType(), parseEventId(), ParticipantSection, Component, validBackQueryParams(), isEventScheduleType() (+42 more)
...
Cohesion: 0.11
Nodes (5): CelebrationEventScaleRequestDTO, EventAssignmentReadService, CelebrationEventServiceImpl, Service, ScaleParticipantEligibility

### Community 50 - "Event Assignment Parallel Cutover Consistency Test"
Cohesion: 0.14
Nodes (11): EventAssignmentParallelCutoverConsistencyIntegrationTest, AutoConfigureMockMvc, EntityManager, EntityManagerFactory, JdbcTemplate, JsonNode, MockMvc, ObjectMapper (+3 more)

### Community 51 - "Celebration Event Scale Person/Response DTO"
Cohesion: 0.18
Nodes (9): EventAssignmentRepository, Query, Repository, EventAssignmentCompatibilityServiceImpl, Override, Service, Transactional, ExtendWith (+1 more)
...
Cohesion: 0.24
Nodes (13): CelebrationEventController, DeleteMapping, GetMapping, Operation, Page, PostMapping, PreAuthorize, PutMapping (+5 more)
...
Cohesion: 0.08
Nodes (12): EucharisticMinisterRequestDTO, EucharisticMinisterResponseDTO, EucharisticMinisterMapper, Mapper, Mapping, EucharisticMinisterService, Override, Transactional (+4 more)

### Community 60 - "Priest Service Impl & Test"
Cohesion: 0.12
Nodes (12): PriestRequestDTO, Mapper, Mapping, PriestMapper, Override, Service, Transactional, PriestServiceImpl (+4 more)
...
Cohesion: 0.09
Nodes (6): CelebrationEventMapper, Mapper, Mapping, EventAssignmentCompatibilityService, Override, Transactional

### Community 64 - "Location Service Impl & Test"
Cohesion: 0.23
Nodes (5): Override, Transactional, LocationServiceImpl, Test, LocationServiceImplTest
...
Cohesion: 0.08
Nodes (11): MinistryType, COMMENTATOR, EUCHARISTIC_MINISTER, MINISTER_OF_THE_WORD, PRIEST, READER, Entity, PrePersist (+3 more)
...
Cohesion: 0.10
Nodes (8): EventScheduleEditComponent, filterByName(), loadErrorMessageFor(), parseEventId(), saveErrorMessageFor(), toDetailResponse(), Component, uniqueIds()

### Community 78 - "Person Controller"
Cohesion: 0.18
Nodes (13): ApiResponses, GetMapping, Operation, Page, PreAuthorize, PutMapping, RequestMapping, ResponseEntity (+5 more)
...
Cohesion: 0.18
Nodes (4): PersonMinistriesUpdateRequestDTO, PersonMinistriesResponseDTO, PersonMinistrySyncResult, Page
...
Cohesion: 0.08
Nodes (19): DeleteMapping, GetMapping, Operation, PostMapping, PreAuthorize, PutMapping, RequestMapping, ResponseEntity (+11 more)
...
Cohesion: 0.08
Nodes (28): Bean, Configuration, OpenApiConfig, EucharisticMinisterController, DeleteMapping, GetMapping, Operation, PostMapping (+20 more)
...
Cohesion: 0.10
Nodes (14): EucharistScaleEventProjection, CelebrationEventRepository, Page, Pageable, Repository, Page, Pageable, EucharistScaleReadCutoverParallelFailureIntegrationTest (+6 more)
...
Cohesion: 0.06
Nodes (20): DeleteMapping, GetMapping, Operation, PostMapping, PreAuthorize, PutMapping, RequestMapping, ResponseEntity (+12 more)

### Community 102 - "Person Admin Response DTO"
Cohesion: 0.13
Nodes (4): PersonAdminResponseDTO, Mapper, Mapping, PersonAdminMapper

### Community 103 - "Commentator/Eucharistic Minister Mapper & Entity"
Cohesion: 0.42
Nodes (3): PersonMinistryDiff, Test, PersonMinistryDiffTest
...
Cohesion: 0.13
Nodes (9): AfterEach, Bean, Statistics, TestConfiguration, SqlCapture, SqlCaptureConfiguration, SqlCheckedRequest, FunctionalInterface (+1 more)
...
Cohesion: 0.19
Nodes (5): LocationRequestDTO, Mapper, Mapping, LocationMapper, ExtendWith

### Community 114 - "CelebrationEvent"
Cohesion: 0.15
Nodes (4): CelebrationEvent, Entity, Override, Table

### Community 115 - "Location Entity"
Cohesion: 0.17
Nodes (5): EventAssignment, Entity, PrePersist, PreUpdate, Table

### Community 116 - ".authenticate"
Cohesion: 0.23
...
Cohesion: 0.32
Nodes (10): AuthenticationProvider, CustomPasswordAuthenticationProvider, Authentication, OAuth2AuthorizationService, OAuth2Token, OAuth2TokenGenerator, PasswordEncoder, UserDetailsService (+2 more)
...
### Community 125 - "EventScheduleType"
Cohesion: 0.20
Nodes (6): EventScheduleType, COMMENTATOR, EUCHARISTIC_MINISTER, MINISTER_OF_THE_WORD, PRIEST, READER
...
Cohesion: 0.13
Nodes (7): Entity, Override, Table, Location, Repository, LocationRepository, Service

### Community 130 - "MonthlyScheduleReadCutoverParallelFailureIntegrationTest"
Cohesion: 0.35
...
### Community 140 - "PersonDetailsServiceImpl.java"
Cohesion: 0.33
...
### Community 165 - "EucharisticMinisterWriteThroughRollbackIntegrationTest.java"
Cohesion: 0.43
Nodes (3): EucharisticMinisterWriteThroughRollbackIntegrationTest, SpringBootTest, Test
