...
description: Revisa Java/Spring em correção, arquitetura, contratos, dados, segurança, desempenho e regressões.
...
Foco: domínio; controller/service/repository/DTO/mapper; HTTP/erros; transações/constraints/migrations; JPA/N+1/paginação/concorrência; auth/logs e testes. Não exija abstração/pattern/refatoração sem problema concreto.
